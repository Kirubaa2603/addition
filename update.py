...
study_tips = [
    ...
    "🛠️ Break large tasks into smaller chunks to avoid feeling overwhelmed.",
    "🖍️ Use mnemonic devices to memorize complex concepts.",
...
# Sidebar
st.sidebar.title("🛠️ MindEase Tools")

...
anxiety_relief_prompts = [
    "🌬️ Take a deep breath. Inhale for 4 seconds, hold for 4, and exhale for 6.",
    "🏝️ Close your eyes and picture your happy place. Stay there for a moment.",
    "✍️ Write down what’s bothering you and set it aside for later.",
...
# Sidebar with Lavender Background & Black Text
st.sidebar.markdown("""
    <style>
...
st.sidebar.title("💜 MindEase Tools", help="Your support system during studies")
...
prompt_mapping = {
    ...
    "Frustrated": "🌬️ Take a deep breath. A short break might help clear your mind.",
    "Tired": "💤 Rest is just as important as work. Give yourself a moment to recharge."
}
st.write(prompt_mapping[emotion])

# Daily Affirmations (Before Study Planner)
st.subheader("✨ Daily Affirmation")
current_date = datetime.datetime.now().day
affirmation = motivation_prompts[current_date % len(motivation_prompts)]
st.markdown(f'<div style="background-color:#E6E6FA; padding:10px; border-radius:10px;"><span style="color:black; font-weight:bold;">{affirmation}</span></div>', unsafe_allow_html=True)
